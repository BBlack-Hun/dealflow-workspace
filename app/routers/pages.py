...
def deals_page(
    ...
    ctx.update({
        ...
        # 붙여넣기 칸의 **예시 한 줄**. 화면에 직접 적어 두면 시킬 말이 적어 준
        # 모양과 갈리고, 그러면 사람이 보는 예시와 LLM 이 받은 지시가 달라진다
        # — 그 차이는 [번호 → 이름 찾기] 가 못 읽는 답으로 돌아온다.
        "llm_answer_example": llm_brief.ANSWER_EXAMPLE,
        # ── 손으로 보낸 것 적기 ────────────────────────────────────────────
        #
