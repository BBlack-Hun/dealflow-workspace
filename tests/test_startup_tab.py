...
# 밀어야 닿는 자리가 된다.
#
# 계약 세 칸 뒤에 **골라 넣는 상태 세 칸**(제안서 ①·②·④)이 선다. 달에 매이지
# 않는 값이라 월별 칸보다 앞이다 — 달 칸 사이에 세우면 달이 바뀔 때 지난달
# 것으로 접힌다(`contact_columns.STARTUP_LAYOUT` 의 같은 자리 주석).
HEAD = ["NO", "기업명", "성함", "연락처", "이메일",
        "견적서 첨부여부", "계약여부", "계약서 수신여부",
        "투자유치 상태", "당사 협업 상태", "회신 상태"]
